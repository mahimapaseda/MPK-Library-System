    ...
    <AppLayout title="Books Management">
        ...
        <transition enter-active-class="transition duration-300 ease-out" enter-from-class="opacity-0 scale-95" enter-to-class="opacity-100 scale-100" leave-active-class="transition duration-200 ease-in" leave-from-class="opacity-100 scale-100" leave-to-class="opacity-0 scale-95">
            <div v-if="showAddModal" class="fixed inset-0 bg-white/24 dark:bg-black/60 backdrop-blur-md flex items-center justify-center p-4 z-50">
                <div class="w-full max-w-xl overflow-hidden rounded-4xl border border-white/70 bg-white/78 shadow-[0_24px_80px_rgba(15,23,42,0.22)] backdrop-blur-2xl dark:border-slate-700/30 dark:bg-slate-900/40">
